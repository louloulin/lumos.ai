...
async fn main() -> Result<()> {
    ...
    // 测试工具功能
    let calc_result = calculator.execute(
    ...
    let text_result = analyzer.execute(
    ...
    // 故意触发一个错误来展示友好错误处理
    let error_result = calculator.execute(
