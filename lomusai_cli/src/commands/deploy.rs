...
use crate::util::{find_project_root, is_lomus_project, create_dir_all, copy_dir_all, check_command_available};
...
"#;
    ...
    let image_name = format!("lomusai/{}", project_name).to_lowercase();
