//! Lomusai MCP module provides a Rust implementation of the Model Context Protocol.
//!
//! This module allows for interaction with MCP servers to access tools and resources
//! that can be used by agents and other components of the Lomusai framework.
