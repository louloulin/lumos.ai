//! Integration with lomusai_rag for vector store retrieval
//!
//! This module provides implementations of the VectorStore trait from lomusai_rag
...
use lomusai_rag::error::{RagError, Result};
use lomusai_rag::embedding::EmbeddingProvider;
use lomusai_rag::types::{Document, RetrievalOptions, RetrievalResult, Metadata};
...
/// A vector store retriever that implements the lomusai_rag VectorStore trait
/// using any lomusai_stores vector store implementation
