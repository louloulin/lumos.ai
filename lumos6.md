...
| 优先级 | 任务 | 原因 | 工期 | 阻塞性 |
|--------|------|------|------|--------|
| **P0-A** | 真正的 JWT Auth 实现 | 当前是假实现，安全风险极高 | 5天 | 🔴 阻塞生产 |
| **P0-B** | Dockerfile + Compose | 完全无法部署 | 2天 | 🔴 阻塞部署 |
| **P0-C** | CI/CD 基础流程 | 无法保证质量 | 3天 | 🔴 阻塞发布 |
| **P0-D** | E2E 测试框架 | 无法验证整体可用性 | 4天 | 🔴 阻塞验收 |
