...
impl BindingError {
        ...
        match self {
            Self::Core { message } => ErrorContext {
                ...
                documentation_url: Some(
                    "https://docs.lumosai.com/troubleshooting/core-errors".to_string(),
                ),
            },
            ...
            Self::Runtime { message } => ErrorContext {
                ...
                message: message.clone(),
                details: None,
                suggestions: vec!["重试操作".to_string(), "检查系统资源是否充足".to_string()],
                category: ErrorCategory::System,
                severity: ErrorSeverity::Medium,
                retryable: true,
                documentation_url: Some(
                    "https://docs.lumosai.com/troubleshooting/runtime-errors".to_string(),
                ),
            },
            ...
            Self::Network { message } => ErrorContext {
                ...
                retryable: true,
                documentation_url: Some(
                    "https://docs.lumosai.com/troubleshooting/network-issues".to_string(),
                ),
            },
            Self::Timeout { timeout_seconds } => ErrorContext {
                ...
                retryable: true,
                documentation_url: Some(
                    "https://docs.lumosai.com/configuration/timeouts".to_string(),
                ),
            },
            _ => ErrorContext {
    ...
    pub fn is_retryable(&self) -> bool {
        matches!(
            self,
            Self::Runtime { .. } | Self::Network { .. } | Self::Timeout { .. } | Self::Tool { .. }
        )
    }
}
