...
mod tests {
    ...
    async fn test_project_creation() {
        ...
        // Test basic template
        let result =
            Commands::new_project("test-project", "basic", Some(project_path.clone())).await;
    ...
    async fn test_add_model() {
        ...
        Commands::new_project("test-project", "basic", Some(project_path.clone()))
            .await
            .unwrap();
    ...
    fn test_enhanced_errors() {
        use super::enhanced_errors::{ErrorHandler, LumosCliError};
    ...
    async fn test_build_command() {
        ...
        Commands::new_project("build-test-project", "basic", Some(project_path.clone()))
            .await
            .unwrap();
    ...
    async fn test_format_and_lint() {
        ...
        // Create a basic project
        Commands::new_project("format-test-project", "basic", Some(project_path.clone()))
            .await
            .unwrap();
...
mod benchmarks {
    ...
    async fn benchmark_project_creation() {
        ...
        for i in 0..10 {
            ...
            let _ =
                Commands::new_project(&format!("bench-project-{}", i), "basic", Some(project_path))
                    .await;
        }
