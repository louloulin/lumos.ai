...
impl RBACManager {
    ...
    fn initialize_defaults(&mut self) {
        ...
        let permissions = vec![
            ...
            Permission::new(
                "tools:delete".to_string(),
                "Delete tools".to_string(),
                "tools".to_string(),
                "delete".to_string(),
            ),
            Permission::new(
                "workflows:create".to_string(),
                "Create workflows".to_string(),
                "workflows".to_string(),
                "create".to_string(),
            ),
            Permission::new(
            ...
            Permission::new(
                ...
                "Execute workflows".to_string(),
                "workflows".to_string(),
                "execute".to_string(),
            ),
            Permission::new(
                "admin:*".to_string(),
                "Full admin access".to_string(),
                "*".to_string(),
                "*".to_string(),
            ),
        ];
        ...
        let mut developer_role =
            Role::system_role("developer".to_string(), "Developer role".to_string());
        ...
        let mut admin_role =
            Role::system_role("admin".to_string(), "Administrator role".to_string());
...
mod tests {
    ...
    async fn test_permission_checking() {
        ...
        assert!(rbac
            ...
            .unwrap());
        assert!(rbac
            .check_permission(&user_id, "agents:read")
            .await
            .unwrap());
        assert!(!rbac
    ...
    async fn test_admin_wildcard_permissions() {
        ...
        assert!(rbac
            ...
            .unwrap());
        assert!(rbac
            .check_permission(&user_id, "tools:delete")
            .await
            .unwrap());
        assert!(rbac
