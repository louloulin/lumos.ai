...
impl Default for YamlConfig {
    fn default() -> Self {
        ...
        let workflow_step = WorkflowStepConfig {
            id: Some("step1".to_string()),
            name: Some("Initial Step".to_string()),
            description: Some("Default workflow step".to_string()),
        ...
        workflows.insert(
            ...
            WorkflowConfig {
                id: Some("default_wf".to_string()),
                name: Some("Default Workflow".to_string()),
                description: Some("Autogenerated workflow".to_string()),
        ...
        Self {
            project: Some(ProjectConfig {
                ...
                description: Some("Starter configuration generated by LumosAI".to_string()),
                author: Some("LumosAI".to_string()),
            }),
            agents: Some(agents),
