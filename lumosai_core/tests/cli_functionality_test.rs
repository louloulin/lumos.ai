...
async fn test_deployment_config() {
    ...
    platforms.insert(
        ...
        lumosai_core::cli::PlatformConfig {
...
async fn test_dev_server_utils() {
    ...
    assert!(
        lumosai_core::cli::dev_server::DevServerUtils::should_ignore_path(
            &target_path,
            &ignore_patterns
        )
    );
...
async fn test_project_stats() {
    ...
    let formatted_size =
        lumosai_core::cli::dev_server::DevServerUtils::format_file_size(stats.total_size);
...
async fn test_template_registry() {
    ...
    let basic_templates =
        registry.get_templates_by_category(lumosai_core::cli::templates::TemplateCategory::Basic);
...
async fn test_deployment_manager() {
    ...
    let deployment_manager =
        lumosai_core::cli::deployment::DeploymentManager::new(project_root, project_config);
