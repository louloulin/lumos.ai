...
pub mod prelude {
    ...
    pub use web_pages::{
        app_layout, base_layout, charts, confirm_modal::ConfirmModal, hero, logout_form, menu,
        profile, profile_popup, snackbar,
    };

    // All page modules
    pub use web_pages::{
        api_keys, assistants, audit_trail, console, datasets, documents, history, integrations,
        models, my_assistants, pipelines, rate_limits, team, teams, workflows,
    };
    ...
    // Utility functions
    pub use web_pages::{render, string_to_visibility, visibility_to_string};
}
