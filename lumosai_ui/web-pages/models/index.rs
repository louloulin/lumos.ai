        ...
        Layout {
            ...
            for (model, has_function_calling, has_vision, has_tool_use) in &models_with_capabilities {
                super::form::Form {
                    ...
                    rpm_limit: model.rpm_limit.unwrap_or(0),
                    context_size_bytes: model.context_size.unwrap_or(0),
                    description: model.description.clone().unwrap_or_default(),
                    disclaimer: model.disclaimer.clone().unwrap_or_default(),
                    example1: model.example1.clone().unwrap_or_default(),
                    example2: model.example2.clone().unwrap_or_default(),
                    example3: model.example3.clone().unwrap_or_default(),
                    example4: model.example4.clone().unwrap_or_default(),
