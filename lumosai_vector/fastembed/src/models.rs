...
impl FastEmbedModel {
    ...
    pub fn language_support(&self) -> Vec<&str> {
        match self {
            ...
            | FastEmbedModel::MultilingualE5Large => {
                vec![
                    "en", "zh", "es", "fr", "de", "it", "pt", "ru", "ja", "ko", "ar", "hi", "th",
                    "vi", "id", "ms", "tl", "nl", "sv", "da", "no", "fi", "pl", "cs", "sk", "hu",
                    "ro", "bg", "hr", "sl", "et", "lv", "lt", "mt", "ga", "eu", "ca", "gl", "cy",
                    "is", "mk", "sq", "sr", "bs", "me", "hr", "sl", "sk", "cs",
                    "pl",
    ...
    pub fn model_family(&self) -> ModelFamily {
        match self {
            ...
            FastEmbedModel::AllMiniLML6V2 | FastEmbedModel::AllMiniLML12V2 => ModelFamily::MiniLM,
