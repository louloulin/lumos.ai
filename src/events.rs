...
pub use lumosai_core::agent::events::{
    AgentEvent, EventBus as CoreEventBus, EventFilter, EventHandler as CoreEventHandler,
...
/// }
/// ```
pub async fn get_history(event_bus: &EventBus, filter: Option<EventFilter>) -> Vec<AgentEvent> {
...
mod tests {
    ...
    async fn test_metrics_handler() {
        ...
        let metrics_handler = register_metrics_handler(&event_bus)
            .await
